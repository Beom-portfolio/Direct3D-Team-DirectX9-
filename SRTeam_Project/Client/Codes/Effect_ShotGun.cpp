#include "stdafx.h"
#include "..\Headers\Effect_ShotGun.h"

#include "Object_Manager.h"
#include "Component_Manager.h"

CEffect_ShotGun::CEffect_ShotGun(LPDIRECT3DDEVICE9 pGraphicDev)
...
HRESULT CEffect_ShotGun::Ready_GameObject(const _vec3 * vPos)
{
...
_int CEffect_ShotGun::Update_GameObject(const _float & fTimeDelta)
{
...
_int CEffect_ShotGun::LastUpdate_GameObject(const _float & fTimeDelta)
{
	if (0 >= m_tInfo.iHp)
		m_tInfo.bDie = true;
...
void CEffect_ShotGun::Render_GameObject(void)
{
...
HRESULT CEffect_ShotGun::Ready_Component()
{
	...
	pComponent = m_pTextureCom = DCAST(Engine::CTexture*, CComponent_Manager::GetInstance()->Clone_Component(SCENE_STATIC, L"Component_Texture_ShotGun_Effect"));
	if (nullptr == pComponent)
		return E_FAIL;
...
CEffect_ShotGun * CEffect_ShotGun::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3 * vPos)
{
	CEffect_ShotGun* pInstance = new CEffect_ShotGun(pGraphicDev);
