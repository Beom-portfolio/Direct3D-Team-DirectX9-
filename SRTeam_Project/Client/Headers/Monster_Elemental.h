...
class CMonster_Elemental : public CGameObject
{
...
private:
	explicit CMonster_Elemental(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
	virtual ~CMonster_Elemental() = default;
...
public:
	static CMonster_Elemental* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
protected:
