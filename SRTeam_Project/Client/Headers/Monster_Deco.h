...
{
public:
	enum Monster_State_Deco { WALK, ATTACK, DIE };
private:
	explicit CMonster_Deco(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
	virtual ~CMonster_Deco() = default;
public:
...
public:
	static CMonster_Deco* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
protected:
...
private:
	Monster_State_Deco				m_eState = WALK;
