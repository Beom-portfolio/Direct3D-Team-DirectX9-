...
class CMonster_Baron : public CGameObject
{
public:
	enum Monster_State_Baron {WALK, HIT, ATTACK, DIE};

private:
	explicit CMonster_Baron(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
	virtual ~CMonster_Baron() = default;
...
public:
	static CMonster_Baron* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
protected:
...
private:
	Monster_State_Baron				m_eState = WALK;
