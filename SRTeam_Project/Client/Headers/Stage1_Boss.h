...
private:
	explicit CStage1_Boss(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
...
public:
	static CStage1_Boss* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
protected:
...
private:
	...
	_vec3							m_vTempStartPosBullet{ 0.f, 0.f, 0.f };
