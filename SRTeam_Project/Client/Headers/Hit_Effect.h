...
class CHit_Effect : public CGameObject
{
public:
	explicit CHit_Effect(LPDIRECT3DDEVICE9 pGraphicDev, SCENETYPE eStage);
...
public:
	static CHit_Effect* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vPos, const _vec3* vLook, SCENETYPE eStage);
