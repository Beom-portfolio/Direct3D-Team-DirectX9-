...
class CMonster_Sergeant : public CGameObject
{
public:
	enum Monster_State { WALK, WALK_LEFT, WALK_RIGHT, HIT, ATTACK, DIE };

private:
	explicit CMonster_Sergeant(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
	virtual ~CMonster_Sergeant() = default;
...
public:
	static CMonster_Sergeant* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* vStartPos, SCENETYPE eStage);
protected:
